...
class Plot_and_save(object):
    ...
    def sample_images(self, samples, epoch, is_last_epoch):
        ...
        ax1.hist(self.E_l0, bins=50, histtype=u'step',label='Original')
        ax1.hist(l0, bins=50, histtype=u'step',label='Generated')
        ax1.set_title('Layer 0')
        ax1.legend()

        ax2 = fig.add_subplot(232)
        ax2.hist(self.E_l1, bins=50, histtype=u'step',label='Original')
        ...
        ax5.hist(self.E_l12, bins=50, histtype=u'step',label='Original')
