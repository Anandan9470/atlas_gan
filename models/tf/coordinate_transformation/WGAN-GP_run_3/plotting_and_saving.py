...
#              .format(epoch, dst_l0, dst_l1, dst_l2, dst_l3, dst_l12, dst_tot))
        ...
        if epoch%500 == 499:
            print("Epoch:{}; Total_dst:{:.3}".format(epoch, dst_tot))
...
#            ax1.hist(self.E_l0, bins=50, histtype=u'step',label='Real')
#            ax1.hist(l0, bins=50, histtype=u'step',label='Generated')
#            ax1.set_title('Layer 0')
#            ax1.legend()
#    
#            ax2 = fig.add_subplot(232)
#            ax2.hist(self.E_l1, bins=50, histtype=u'step',label='Real')
#            ax2.hist(l1, bins=50, histtype=u'step',label='Generated')
#            ax2.set_title('Layer 1')
#            ax2.legend()
#    
#            ax3 = fig.add_subplot(233)
#            ax3.hist(self.E_l2, bins=50, histtype=u'step',label='Real')
#            ax3.hist(l2, bins=50, histtype=u'step',label='Generated')
#            ax3.set_title('Layer 2')
#            ax3.legend(bbox_to_anchor=(0.01, 1), loc=2)
#    
#            ax4 = fig.add_subplot(234)
#            ax4.hist(self.E_l3, bins=50, histtype=u'step',label='Real')
#            ax4.hist(l3, bins=50, histtype=u'step',label='Generated')
#            ax4.set_title('Layer 3')
#            ax4.legend()
#    
#            ax5 = fig.add_subplot(235)
#            ax5.hist(self.E_l12, bins=50, histtype=u'step',label='Real')
#            ax5.hist(l12, bins=50, histtype=u'step',label='Generated')
#            ax5.set_title('Layer 12')
#            ax5.legend()
#    
#            ax6 = fig.add_subplot(236)
#            ax6.hist(self.E_ltot, bins=50, histtype=u'step',label='Real')
#            ax6.hist(ltot, bins=50, histtype=u'step',label='Generated')
#            ax6.set_title('All layers')
#            ax6.legend(bbox_to_anchor=(0.01, 1), loc=2)
#            fig.savefig("out/evolution_hist/sample_hist_%d_%10.4f.png" %(epoch, dst_tot))
#            plt.close()
            
            fig = plt.figure(figsize=(20,10))
            ax = fig.add_subplot(111)
            ax.hist(self.E_ltot, bins=50, histtype=u'step',label='Real', log=True)
            ax.hist(ltot, bins=50, histtype=u'step',label='Generated', log=True)
            ax.legend(bbox_to_anchor=(0.01, 1), loc=2)
            ax.set_xlim([40000, 75000])
            fig.savefig("out/evolution_hist/sample_hist_%d_%10.4f.png" %(epoch, dst_tot))
            plt.close()
            
            np.savetxt('out/samples/samples_%d_%10.4f.csv' %(epoch, dst_tot), samples, delimiter=',')
